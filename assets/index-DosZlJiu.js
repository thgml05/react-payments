...
const InputContainer = ({ children, title, subTitle }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.inputContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: styles$3.inputTitle, children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$3.inputSubTitle, children: subTitle }),
    children
  ] });
};
...
const validateCardPassword = (number, length) => {
  if (!isNumber(number)) throw new Error(ERROR.REQUIRE.NUMBER);
  if (invalidNumberLength(number, length))
    throw new Error(`${length}${ERROR.REQUIRE.SPECIFIC_LENGTH}`);
};
const useCardNumbers = () => {
  ...
  const [isErrors, setIsErrors] = reactExports.useState([false, false, false, false]);
  const [errorMessage, setErrorMessage] = reactExports.useState("");
  const cardNumbersRef = reactExports.useRef([]);
  const [isComplete, setIsComplete] = reactExports.useState(false);
  const [isDisplay, setIsDisplay] = reactExports.useState(false);
  const updateCardNumber = (e, index) => {
    var _a;
    ...
    if (e.target.value.length === CARD_VALIDATION_INFO.CARD_MAX_LENGTH) {
      (_a = cardNumbersRef.current[index + 1]) == null ? void 0 : _a.focus();
    }
  };
...
const useExpiry = () => {
  ...
  const [isErrors, setIsErrors] = reactExports.useState([false, false]);
  const [errorMessage, setErrorMessage] = reactExports.useState("");
  const expiryRef = reactExports.useRef([]);
  const [isComplete, setIsComplete] = reactExports.useState(false);
  const [isDisplay, setIsDisplay] = reactExports.useState(false);
  const updateDate = (e) => {
    var _a;
    ...
    validate(name, value);
    const isMonthValid = (name === "month" ? value : month).length === CARD_VALIDATION_INFO.EXPIRE_DATE_MAX_LENGTH;
    const isYearValid = (name === "year" ? value : year).length === CARD_VALIDATION_INFO.EXPIRE_DATE_MAX_LENGTH;
    ...
    if (e.target.value.length === CARD_VALIDATION_INFO.EXPIRE_DATE_MAX_LENGTH) {
      (_a = expiryRef.current[1]) == null ? void 0 : _a.focus();
    }
  };
...
const useCVC = () => {
  ...
  const [isErrors, setIsErrors] = reactExports.useState(false);
  const [errorMessage, setErrorMessage] = reactExports.useState("");
  const [isComplete, setIsComplete] = reactExports.useState(false);
  const [isDisplay, setIsDisplay] = reactExports.useState(false);
  const updateCVC = (e) => {
...
const CardFormContext = reactExports.createContext(null);
const CardFormProvider = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CardFormContext.Provider, { value, children });
};
const useCardFormContext = () => {
  const context = reactExports.useContext(CardFormContext);
  if (!context) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    InputContainer,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `helperText`, "data-testid": "helper-text", children: cardNumbersErrorMessage })
      ]
    }
  );
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    InputContainer,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "helperText", "data-testid": "helper-text", children: expireErrorMessage })
      ]
    }
  );
};
const CVCInput = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(InputContainer, { title: INPUT_CONTAINER.CVC.TITLE, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "helperText", "data-testid": "helper-text", children: CVCErrorMessage })
  ] });
};
const preview = "_preview_16x9c_12";
const bc = "_bc_16x9c_26";
const shinhan = "_shinhan_16x9c_30";
const kakao = "_kakao_16x9c_34";
const hyundai = "_hyundai_16x9c_38";
const woori = "_woori_16x9c_42";
const lotte = "_lotte_16x9c_46";
const hana = "_hana_16x9c_50";
const kb = "_kb_16x9c_54";
const magnetic = "_magnetic_16x9c_58";
const visa = "_visa_16x9c_66";
const cardInfo = "_cardInfo_16x9c_74";
const cardNumberContainer = "_cardNumberContainer_16x9c_81";
const date = "_date_16x9c_95";
const styles$2 = {
  preview,
  bc,
  shinhan,
...
const CardPreview = () => {
  ...
  const isMasterCard = () => {
    return VALID_MASTER_CARD_START_NUMBER.some(
      (condition) => cardNumbers[0].startsWith(condition)
    );
  };
  const isHiddenCardIndex = (index) => HIDDEN_CARD_NUMBER_INDEX.includes(index);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${styles$2.preview} ${styles$2[brand]}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./magnetic.png", alt: "magnetic", className: styles$2.magnetic }),
    isVisaCard() && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./Visa.png", alt: "visa", className: styles$2.visa }),
    isMasterCard() && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./Mastercard.png", alt: "visa", className: styles$2.visa }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.cardInfo, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.cardNumberContainer, children: cardNumbers.map((number, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "data-testid": `card-number-${index}`, children: isHiddenCardIndex(index) ? "•".repeat(number.length) : number }, index)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.date, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        month,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", disabled: true, hidden: true, children: OPTION_MESSAGE.SELECT_CARD_BRAND }),
              Object.entries(CARD_BRANDS).map(([key, value], index) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: key, children: value }, index))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "helperText", "data-testid": "helper-text" })
      ]
    }
  );
};
const CardPasswordInput = () => {
  const { password, updatePassword, passwordError, passwordErrorMessage } = useCardFormContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    InputContainer,
    {
      title: "비밀번호를 입력해 주세요",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "label", children: "비밀번호 앞 2자리" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inputContainer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "password",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "helperText", "data-testid": "helper-text", children: passwordErrorMessage })
      ]
    }
  );
};
const button = "_button_187h5_1";
const styles$1 = {
  button
};
const Button = ({ text: text2, onClick = () => {
} }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `${styles$1.button} `, type: "submit", onClick, children: text2 });
};
const HomePage = () => {
  const {
    cardNumbers,
  ...
  const isFormComplete = cardNumberComplete && brandComplete && expireComplete && CVCComplete && passwordComplete;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardPreview, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      cardPasswordDisplay ? /* @__PURE__ */ jsxRuntimeExports.jsx(CardPasswordInput, {}) : "",
      cardCVCDisplay ? /* @__PURE__ */ jsxRuntimeExports.jsx(CVCInput, {}) : "",
      cardExpiryDisplay ? /* @__PURE__ */ jsxRuntimeExports.jsx(CardExpiryInput, {}) : "",
      cardBrandDisplay ? /* @__PURE__ */ jsxRuntimeExports.jsx(CardBrandInput, {}) : "",
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumbersInput, {}),
      isFormComplete ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { text: "확인" }) : ""
    ] })
  ] });
};
const container = "_container_1qjiq_1";
const text = "_text_1qjiq_26";
const styles = {
  container,
  "small-container": "_small-container_1qjiq_9",
  "check-image": "_check-image_1qjiq_20",
  text
};
const CardRegisterSuccessPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const { cardNumbers, brand } = location.state;
  const firstCardNumbers = cardNumbers[0];
  const handleClick = () => {
    navigate("/react-payments/");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles["container"], children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles["small-container"], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: styles.text, "data-testid": "success-message", children: [
      firstCardNumbers,
      "로 시작하는",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { text: "확인", onClick: handleClick })
  ] }) });
};
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/react-payments", element: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/react-payments/complete",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(CardRegisterSuccessPage, {})
      }
    )
  ] }) });
};
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardFormProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
